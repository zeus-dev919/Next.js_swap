            ...
            <div className="rounded-md modal-content desktop:w-4/12 laptop:w-5/12 tablet:w-6/12 phone:w-8/12">
                ...
                <div className="p-2 mt-6">
                    ...
                    <div className="flex flex-row mx-auto mt-4 mr-auto rounded desktop:w-7/12 laptop:w-6/12 tablet:w-6/12 phone:w-8/12">
                        ...
                        <button className="w-2/5 rounded-sm" style={{ backgroundImage: "linear-gradient(90deg, rgba(250, 2, 255, 0.1) -3.16%, rgba(6, 214, 223, 0.1) 100%)" }}><p className=" desktop:text-2xl laptop:text-xl tablet:text-base phone:text-sm">ITEMS</p></button>
                    </div>
                </div>
            </div>
        </div>
