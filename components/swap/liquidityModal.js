...
const LiquidityModal = () => {
    ...
    const drawScreen = () => {
        if (desktop) {
            return (
                <section className="flex flex-col justify-center m-auto bg-white shadow-lg shadow-indigo-500/50 " style={{ position: "absolute", top: "382px", marginLeft: "400px", width: "640px", padding: "60px", borderRadius: "20px" }}>
