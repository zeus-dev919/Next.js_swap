const LandingPage = () => {
    return (
        <section className="desktop:py-40 laptop:py-36 tablet:py-24 phone:py-12 bg-1d1d28">
            <p className="text-center smells_good desktop:text-5xl laptop:text-3xl tablet:text-xl phone:text-lg">Something Smells Good</p>
            <img src='/landingpage/curve.svg' className="m-auto desktop:w-3/5 laptop:w-4/5 tablet:w-full phone:w-full" />
            <div className="flex flex-row p-4 m-auto desktop:w-3/5 laptop:w-4/5 tablet:w-full phone:w-full phone:flex-col desktop:flex-row laptop:flex-row tablet:flex-row">
                ...
                <p className="m-auto phone:text-center desktop:w-2/3 laptop:w-2/3 tablet:w-2/3 phone:w-full desktop:mx-36 laptop:mx-24 desktop:mt-36 laptop:mt-24 smells_good desktop:text-3xl laptop:text-xl tablet:text-lg phone:text-lg tablet:mx-20 tablet:mt-20">We are making desert</p>
            </div>
            ...
            <p className="text-center desktop:mt-24 laptop:mt-16 tablet:mt-12 phone:mt-8 smells_good desktop:text-5xl laptop:text-3xl tablet:text-xl phone:text-lg">Available On</p>
            ...
            <div className="flex flex-row justify-between p-8 m-auto desktop:mt-24 laptop:mt-16 tablet:mt-12 phone:mt-8 desktop:w-6/12 laptop:w-9/12 tablet:w-full phone:w-full ">
                <div className="">
            ...
            <img src='/landingpage/border.svg' className="m-auto desktop:mt-24 laptop:mt-16 tablet:mt-12 phone:mt-8 desktop:w-3/5 laptop:w-4/5 tablet:w-full phone:w-full" />
            <p className="text-center desktop:mt-24 laptop:mt-16 tablet:mt-12 phone:mt-8 smells_good desktop:text-5xl laptop:text-3xl tablet:text-xl phone:text-lg">Join the Community</p>
